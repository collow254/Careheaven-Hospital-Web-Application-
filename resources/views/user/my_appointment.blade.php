...
@foreach($appoint as $appoints)
    <tr>
      ...
      <a class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this appointment?')" href="{{url('delete_appoint', $appoints->id)}}"> Delete</a></td>
    </tr>
  </tbody>
  @endforeach
  </table>
