        ...
        <div class="col-lg-8">
          <nav aria-label="Breadcrumb">
            <ol class="breadcrumb bg-transparent py-0 mb-5">
              <li class="breadcrumb-item"><a href="<?php echo e(url('homepage')); ?>">Home</a></li>
              <li class="breadcrumb-item"><a href="<?php echo e(url('posts')); ?>">Posts</a></li>
              <li class="breadcrumb-item active" aria-current="page"><?php echo e($posts->title); ?></li>
            </ol>
          </nav>
        </div>
      </div> <!-- .row -->
          ...
          <article class="blog-details">
            ...
            <div class="post-meta">
              <div class="post-author">
                <span class="text-grey">By</span> <a href="#"><?php echo e($posts->author); ?></a>  
              </div>
              <span class="divider">|</span>
              <div class="post-date">
                <a href="#"><?php echo e($posts->created_at); ?></a>
              </div>
              <span class="divider">|</span>
              <div>
            ...
            <h2 class="post-title h1"><?php echo e($posts->title); ?></h2>
...
</html><?php /**PATH C:\Users\COLLOW\hospital\hospital\resources\views/user/postdetails.blade.php ENDPATH**/ ?>