    ...
    <div class="container">
      ...
      <div class="row mt-5">
        ...
        <div class="col-12 text-center mt-4 wow zoomIn">
          <a href="<?php echo e(url('posts')); ?>" class="btn btn-primary" style="background-color: blue; color: white">Read More</a>
        </div>

      </div>
     
    </div>
  </div> <!-- .page-section --><?php /**PATH C:\Users\COLLOW\hospital\hospital\resources\views/user/latest.blade.php ENDPATH**/ ?>