...
<div class="page-section">
    <div class="container">
      ...
      <form class="main-form" action="<?php echo e(url('appointment')); ?>" method="POST">
        ...
        <button type="submit" class="btn btn-primary mt-3 wow zoomIn" style="background-color: blue">Submit Request</button>
      </form>
    </div>
  </div> 
</div>

   <?php echo $__env->make('user.scripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\COLLOW\hospital\hospital\resources\views/receptionist/bookappointment.blade.php ENDPATH**/ ?>