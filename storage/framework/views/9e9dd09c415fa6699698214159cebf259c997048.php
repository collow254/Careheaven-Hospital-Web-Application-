 <div class="page-section bg-light">
    <div class="container">
      ...
      <div class="row mt-5">
        ...
        <div class="col-12 text-center mt-4 wow zoomIn">
          <a href="<?php echo e(url('career')); ?>" class="btn btn-primary" style="background-color: blue; color: white">More Careers</a>
        </div>
...
<?php /**PATH C:\Users\COLLOW\hospital\hospital\resources\views/user/career.blade.php ENDPATH**/ ?>