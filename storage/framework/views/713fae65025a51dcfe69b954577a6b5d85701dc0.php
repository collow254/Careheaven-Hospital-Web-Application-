...
<html lang="en">
  ...
  <body class="admin-bg">
        ...
        <!-- partial -->
         <div class="container-fluid page-body-wrapper">
          ...
          <center>
            ...
            <form action="<?php echo e(url('upload_patient')); ?>" method="POST" enctype="multipart/form-data" >
              ...
              <div style="padding: 15px">
                <label>Age</label>
                <input type="number" style="color: black" name="age" placeholder="Age" required="">
              </div>

              <div style="padding: 15px">
                <label>Gender</label>
                <select name="gender" style="color: black; width: 220px" required="">
              ...
              <div style="padding: 15px">
                ...
                <select name="citizenship" style="color: black; width: 220px" required="">
                	<option>--SELECT--</option>
               ...
               <div style="padding: 15px">
                ...
                <input type="number" style="color: black" name="id_number" placeholder="Id/Passport Number" required="">
              </div>

              <div style="padding: 15px">
                <label>County</label>
                <select name="county" style="color: black; width: 220px" required="">
                  <option>--SELECT--</option>
    ...
    <option value="pokot">West Pokot</option>
              ...
              <div style="padding: 15px">
                <label>Village</label>
                <input type="text" style="color: black" name="village" placeholder="Village" required="">
              </div>
              ...
              <div style="padding: 15px">
                ...
                <select name="insurance" style="color: black; width: 220px" required="">
                  <option>--SELECT--</option>
                  <option value="AAR">AAR</option>
                  <option value="Britam">Britam</option>
                  <option value="Equity">Equity</option>
                  <option value="NHIF">NHIF</option>
                  <option value="Kenbright">Kenbright</option>
                  <option value="Saham">Saham</option>
                  <option value="Pacics">Pacics</option>
                  <option value="Madison">Madison</option>
                  <option value="KWS">KWS</option>
                  <option value="Kenya Power">Kenya Power</option>
...
</html><?php /**PATH C:\Users\COLLOW\hospital\hospital\resources\views/receptionist/addpatient.blade.php ENDPATH**/ ?>