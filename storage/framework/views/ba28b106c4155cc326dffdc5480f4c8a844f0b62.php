...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo e(url('elpdashboard')); ?>">My dashboard</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="<?php echo e(url('myposts')); ?>">My Posts</a>
            </li>
  ...
  <div class="page-hero bg-image overlay-dark" style="background-image: url(../assets/img/hos2.jpg);">
    <div class="hero-section">
      <div class="container text-center wow zoomIn">
        ...
        <a href="#" class="btn btn-primary">Consult Us</a>
      </div>
    </div>
  </div>
  ...
  <?php echo $__env->make('elp.career', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
</html><?php /**PATH C:\Users\COLLOW\hospital\hospital\resources\views/elp/elphome.blade.php ENDPATH**/ ?>