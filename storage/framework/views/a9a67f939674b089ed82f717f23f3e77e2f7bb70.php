                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tr align="center" >
                          ...
                          <td><?php echo e($results->test); ?></td>
                          <td><?php echo e($results->created_at); ?></td>
                          <td><a class="btn btn-primary" href="<?php echo e(url('tests', $results->visitId)); ?>">Results</a></td>  
                        </tr>
...
<?php /**PATH C:\Users\COLLOW\hospital\hospital\resources\views/doctor/tests.blade.php ENDPATH**/ ?>